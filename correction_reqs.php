        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h4 class="h6 mb-0 text-dark-800">
              <span style="color:<?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;"> SAISIE <i class="fa fa-angle-double-right" aria-hidden="true"></i> </span> Vigilance
            </h4>
          </div>
          <hr />
          ...
          <div>
            <nav class="nav nav-tabs">
              <a class="nav-tab-item nav-item nav-link active" href="#Traitement" style="color: black;"> Requête </a>
                        ...
                        <div id="form-idlot-field" class="row">
                          <div class="form-group col-md-12">
                            <div class="form-group">
                              <textarea class="form-control" id="text-reqs" rows="10" style="align-content:center; overflow:auto;background:rgba(0,0,0,0.1);color:black;">
                                  </textarea>
                            </div>
                          </div>
                          <div class="form-inline ml-3">
                            <label for="show_all"> Afficher tous </label>
