...
<body id="page-top" idpage="Livraison">
                    ...
                    <div class="row">                      
                      <div class="form-group ml-3">
                        ...
                        <div class="form-inline">
                          <input class="form-control" id="field-nbLotRepartir" style="align-content:center; overflow:auto;height:40px;max-height:70px;min-height:40px;"
                                 value="<?=$nb_lots_repartis?>"/>
                        </div>
                      </div>              
  ...
  <script src="js/ajax/livraison/livraison_split_db.js"></script>
