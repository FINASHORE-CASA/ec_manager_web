<?php
    ...
    try 
    {
        ...
        {            
            $liste_el_select[] = ["id_lot" => $acte->id_lot,"id_acte" => $acte->id_acte , "num_acte" => $acte->num_acte
            ,"imagepath" =>  $acte->imagepath,"id_tome_registre" =>  $acte->id_tome_registre ,"status_acte" =>  $acte->status_acte];          
        }
