        ...
        <div class="container-fluid">
          ...
          <div class="row mt-3 pl-5">                  
              <div class="form-inline mb-5">
                ...
                <button id="btn-upload-csv" type="submit" class="btn btn-dark mr-4" style="background: transparent;color:black;border: 1px solid rgba(0,0,0,0.1);box-shadow: 1px 1px 5px rgba(0,0,0,0.2);">
