...
<body id="page-top" idpage="Livraison">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group ml-3">
                        ...
                        <div class="form-inline">
                          <textarea class="form-control" id="text-list-source" rows="1" style="align-content:center; overflow:auto;height:40px;max-height:70px;min-height:40px;">
                          </textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group ml-3">
                        ...
                        <div class="form-inline">
                          <input class="form-control" id="text-destination" style="align-content:center; overflow:auto;height:40px;max-height:70px;min-height:40px;" />
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-xl-4 mt-4 mb-4">
              ...
              <div id="lot_non_transfere" class="card shadow mt-2" style="display:none;max-height:300px;overflow:auto;">
  ...
  <script src="js/ajax/livraison/livraison_transfert_lot.js?v=1.0.2"></script>
