...
<body id="page-top" idpage="Depot">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h4 class="h6 mb-0 text-dark-800">
              <span style="color:<?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;"> DEPOT <i class="fa fa-angle-double-right" aria-hidden="true"></i> </span> MISE A JOUR
            </h4>
          </div>
          <hr />
              ...
              <div class="card shadow mb-4">
                <form method="post" action="#">
                  <div class="card-header py-3" style="background: <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;">
                    <h6 class="m-0 font-weight-bold text-white"> Upload du fichier de mise à jour</h6>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        <div class="row pl-5 mt-2">
                          <div class="form-inline">
                            <label for="bd_extra" class="mr-5"> IMPORTATION DU FICHIER DE STATS : </label>
                            <input type="file" id="file_upload_maj" style="display: none;" accept=".csv" />
                            <button id="btn-upload-csv-maj" type="button" class="btn btn-dark mr-4" style="background: transparent;color:black;border: 1px solid rgba(0,0,0,0.1);box-shadow: 1px 1px 5px rgba(0,0,0,0.2);">
                          ...
                          <div class="row pl-5 mb-5 mt-2">
                            <i> (Prestataire, Province, Commune, BEC, Num livraison, nomLivraison, Num lot, nbActeTotal, Statut_LOT) </i>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card-footer" id="form-idlot-footer">
                    ...
                    <button type="button" class="btn btn-dark" style="background:  <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;" id="btn-valide-import-maj" disabled>
                      Mettre à jour <span class="badge badge-success" style="font-size:15px;border-radius:100%;padding:5px;"><i class="fas fa-upload"></i> </span>
                    </button>
                  </div>
                </form>
              </div>
              ...
              <div class="card shadow">
                ...
                <div class="card-body">
                  <div class="row d-flex justify-content-center">
                    <div class="form-group">
                      <p id="NombreMaj" style="align-content:center; overflow:auto;display:inherit;font-size:37px;">
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <!-- version 1.0.1 -->
      <script src="js/ajax/sheetApi/setMajLot.js?version=1.0.2"></script>
