<?php
    ...
    try 
    {
        ...
        {
            $liste_el_select[] = ["id_actionec" => $less3min->id_actionec,"date_debut_action" => $less3min->date_debut_action 
            , "date_fin_action" => $less3min->date_fin_action
            ,"new_date_fin_action" => $less3min->new_date_fin];   
        }
