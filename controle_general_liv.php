                ...
                <div class="col-md-10"> 
                  ...
                  <div class="tab-content">
                    ...
                    <!-- <div class="card shadow mb-4 tab-pane" id="Corr3minControleEnd">
                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                        <table class="table table-bordered" id="dataTableCorr3minControleEnd" width="100%" cellspacing="0">
                          <thead>
                            <tr>
                              <th > ID ACTIONEC </th>
                              <th > DATE DEBUT ACTION </th>
                              <th > DATE FIN ACTION </th>
                              <th > NEW DATE FIN ACTION </th>
                            </tr>
                          </thead>
                          <tbody id="TableCorr3minControleEnd">
