...
<body id="page-top" idpage="GestionStats">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <ol id="liste-indic">
                          ...
                          <li class="mb-2" style="display: none;"> Stats Consultation Contrôle Unitaire <i class="fas fa-check text-success" style="margin-left:5px;font-size:20px;"></i> </li>
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    <nav class="nav nav-tabs">
                      ...
                      <a class="nav-tab-item nav-item nav-link" href="#StatsControleUnitaireConsult" style="color: black;"> Stats Consultation Contrôle Unitaire <span class="badge badge-dark ml-2" style="background:red;border-radius:100%;" id="notif-Resultat-2"> 0 </span> <button id="StatsControleUnitaireConsult_dl" class="text-dark ml-2" style="background-color: transparent;border:none;"> <i class="fa fa-download" aria-hidden="true"></i> </button></a>
                  ...
                  <div class="tab-content">
                    ...
                    <!-- Stats Contrôle Unitaire Consult -->
                    <div class="card shadow mb-4 tab-pane" id="StatsControleUnitaireConsult">
                      <div class="card-header py-3" style="background: <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;">
                        <h6 class="m-0 font-weight-bold text-white"> Stats Consultation Contrôle Unitaire </h6>
                      </div>
                      <div class="card-body">
                        <div class="table-responsive">
                          <table class="table table-bordered" id="dataTableStatsControleUnitaireConsult" width="100%" cellspacing="0">
                            <thead>
                              <tr>
                                <th> Login </th>
                                <th> Lot </th>
                            ...
                            <tbody id="TableStatsControleUnitaireConsult">
                    ...
                    <div class="card shadow mb-4 tab-pane" id="StatsManquantMention">
                      <div class="card-header py-3" style="background: <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;">
                        <h6 class="m-0 font-weight-bold text-white"> Stats Mention Manquant </h6>
                      </div>
                      <div class="card-body">
                        <div class="table-responsive">
  ...
  <!-- next version -- 1.0.3   -->
  <script src="js/ajax/stats/stats_controle.js?version=1.0.7"></script>
