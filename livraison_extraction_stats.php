...
<body id="page-top" idpage="GestionECM">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h4 class="h6 mb-0 text-dark-800">
              <span style="color:<?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;"> LIVRAISON <i class="fa fa-angle-double-right" aria-hidden="true"></i> </span> EXTRACTION STATS
            </h4>
          </div>
          <hr />
              ...
              <div>
                ...
                <div class="card shadow mb-4 tab-pane active" id="ImageVide">
                  <div class="card-header py-3" style="background: <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;">
                    <a href="#" id="btn-gen-stats-global" class="btn btn-default float-right" style="color: <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;background:white;">
                      Global
                      <i class="fa fa-download" aria-hidden="true"></i>
                    </a>
                    <a href="#" id="btn-gen-stats-liv" class="btn btn-default float-right mr-2" style="color: <?= isset($main_app_color) ? $main_app_color : "#3b2106"; ?>;background:white;">
                      Livraison
                      <i class="fa fa-download" aria-hidden="true"></i>
                    </a>
                    ...
                    <div class="row mb-4 d-flex justify-content-end mr-4">
                      <div>
                        <div class="input-group" style="width: 250px;">
                          <input class="form-control" type="text" name="" style="border-right:none;" id="search_db" placeholder="recherche..." aria-label="" aria-describedby="my-addon" />
  ...
  <script src="js/ajax/livraison/livraison_extraction_stats.js"></script>
